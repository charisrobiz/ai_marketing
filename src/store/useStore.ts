...
export const CORE_AGENTS: Agent[] = [
  {
    ...
    roleKo: '본부장 (총괄 PM)',
    department: 'pm',
    description: '니치밴딩 전략 총괄, 부서간 협업 조율, 니치 시장 분석/의사결정, 마케팅·디자인팀에 전략 교육 및 전파',
    avatar: '👩‍💼',
    color: '#F59E0B',
  ...
  },
  {
    ...
    description: '니치밴딩 기반 30일 플랜 수립, 극도의 세분화 타겟팅, 볼링핀 전략 확장, A/B 테스트 설계',
    avatar: '📊',
    color: '#FF6B6B',
  ...
  },
  {
    ...
    roleKo: 'SEO 스페셜리스트',
    department: 'marketing',
    description: '니치 롱테일 키워드 전략, 토픽 클러스터 SEO, ASO(앱스토어 최적화), 니치 커뮤니티 오가닉 유입 극대화',
    avatar: '🔍',
    color: '#F472B6',
  ...
  },
  {
    ...
    roleKo: '퍼포먼스 마케터',
    department: 'marketing',
    description: '니치 타겟 리타겟팅, 마이크로 인플루언서 광고, Meta/Google 니치 세그먼트 최적화, 낮은 CPA 달성',
    avatar: '📈',
    color: '#EF4444',
  ...
  },
  {
    ...
    roleKo: '크리에이티브 디렉터',
    department: 'design',
    description: '니치 서브컬처 코드 기반 비주얼 컨셉, 안티-제네릭 브랜드 디자인, 니치 타겟 맞춤 이미지 감수',
    avatar: '🎨',
    color: '#A78BFA',
  ...
  },
  {
    ...
    roleKo: '모션/UX 디자이너',
    department: 'design',
    description: '니치 감성 숏폼 영상 기획, 커뮤니티 바이럴용 모션 그래픽, 니치 타겟 맞춤 UX 디자인',
    avatar: '🎬',
    color: '#8B5CF6',
